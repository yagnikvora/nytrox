...
/* Randomised geometry helpers. Kept at module scope (they only spawn the
   animation particles, never during render) so their use of Math.random isn't
   treated as an impure call during rendering. */
